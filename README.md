...
Contributions to improve the Track Results Display System are welcome! Please feel free to submit pull requests or open issues to suggest improvements.
...
- German Athletics Federation (DLV) for providing the results data structure
- BeautifulSoup and Pandas libraries for data processing capabilities
